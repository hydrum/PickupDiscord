...
public class PickupLogic {
    ...
    private final Map<Team, Gametype> teamsQueued;
    ...
    public void cmdGetData(DiscordChannel channel) {
        ...
        for (Match match : ongoingMatches) {
            String msg = "**" + match.getGametype().getName() + " Match #" + match.getID() + "** " + Config.pkup_pw + " RCON: " + match.getServer().rconpassword + " Server #" + match.getServer().id;
